...
<div class="wrapper">
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                <h2 class="mt-5" style="text-align: center;color: pink">Create Record</h2>
                <p style="text-align: center; color: #1c1a1a">Please fill this form and submit to add employee record to the database.</p>
